...
\begin{figure}[h]
    \centering
    %\includegraphics[width=0.7\textwidth]{connectome.png}
    \caption{Illustration of a human brain connectome. Diffusion MRI and tractography reveal bundles of white-matter fibers connecting cortical regions. Structural connectivity can be represented as a weighted matrix~\cite{ref5,ref7}.}
\end{figure}
